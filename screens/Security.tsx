...
import { ArrowLeft, Lock, ShieldCheck, FileText, EyeOff, Flag, HelpCircle, Info, LogOut, Trash2 } from 'lucide-react';
    ...
    <div className="h-full flex flex-col bg-brand-dark overflow-y-auto no-scrollbar">
      ...
      <div className="p-4 flex-1 flex flex-col">
        ...
        <div className="space-y-3 mb-8">
            ...
            <MenuOption icon={ShieldCheck} label="Autenticação por 2FA" onClick={() => {}} />
